...
namespace MagicLeapWithOpenCVForUnityExample {
    ...
    /// </summary>
    public class ArUcoMLCameraCalibrationExample : MonoBehaviour {
        /// <summary>
        /// The marker type.
        /// </summary>
        ...
        [SerializeField,Tooltip("The speed at which it should be calibrated")]
        uint samplingRate = 20;
        //used to count the skiped frames
        uint frameCount = 0;
